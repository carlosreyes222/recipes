...
data class RecipeResponse(
    ...
    @SerializedName("hits") val recipes: List<Hit>
)
...
data class Hit(
    ...
    @SerializedName("_links") val links: SelfLink
)

data class SelfLink(
    @SerializedName("self") val self: Next
)
...
data class Images(
    @SerializedName("THUMBNAIL") val thumbnail: ImageSize,
    @SerializedName("SMALL") val small: ImageSize,
    @SerializedName("REGULAR") val regular: ImageSize,
